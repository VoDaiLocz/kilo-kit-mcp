...
describe("Kilo-Kit System Health Doctor", () => {
  it("runs full diagnostic suite and returns healthy or degraded status with all 177 skills and 22 tools", async () => {
