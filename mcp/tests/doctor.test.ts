...
describe("Kilo-Kit System Health Doctor", () => {
  it("runs full diagnostic suite and returns healthy or degraded status with all 180 skills and 24 tools", async () => {
